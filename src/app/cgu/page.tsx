...
export default function CGU() {
  return (
    <SecondaryPageLayout
      ...
      subtitle="Dernière mise à jour des conditions d'utilisation de QRTrans"
    >
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <section>
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Les données personnelles collectées par QRTrans sont traitées conformément à notre <a href="/confidentialite" className="text-[#FF6B35] hover:underline">Politique de confidentialité</a> et dans le respect du Règlement Général sur la Protection des Données (RGPD).
          </p>
          <p className="text-gray-600 leading-relaxed">
